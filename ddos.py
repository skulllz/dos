...
print("""\033[1;31m  \033[92m
                                             ,---------,
       ___  ___       __      _____  ___        __       ________   ____  ____       ______    ______   ___      ___    _______     __      _____  ___   ___  ___  
|"  \/"  |     /""\    (\"   \|"  \      /""\     |"      "\ ("  _||_ " |     /" _  "\  /    " \ |"  \    /"  |  |   __ "\   /""\    (\"   \|"  \ |"  \/"  | 
 \   \  /     /    \   |.\\   \    |    /    \    (.  ___  :)|   (  ) : |    (: ( \___)// ____  \ \   \  //   |  (. |__) :) /    \   |.\\   \    | \   \  /  
  \\  \/     /' /\  \  |: \.   \\  |   /' /\  \   |: \   ) ||(:  |  | . )     \/ \    /  /    ) :)/\\  \/.    |  |:  ____/ /' /\  \  |: \.   \\  |  \\  \/   
  /\.  \    //  __'  \ |.  \    \. |  //  __'  \  (| (___\ || \\ \__/ //      //  \ _(: (____/ //|: \.        |  (|  /    //  __'  \ |.  \    \. |  /   /    
 /  \   \  /   /  \\  \|    \    \ | /   /  \\  \ |:       :) /\\ __ //\     (:   _) \\        / |.  \    /:  | /|__/ \  /   /  \\  \|    \    \ | /   /     
|___/\___|(___/    \___)\___|\____\)(___/    \___)(________/ (__________)     \_______)\"_____/  |___|\__/|___|(_______)(___/    \___)\___|\____\)|___/      
...
print(" ")
os.system('espeak  Xanadu-company-'+host)
os.system('clear')
...
tetew('\033[96mCopyright 2020 xanadu company\033[0m')
time.sleep(2)
def janda():
